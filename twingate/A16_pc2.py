...
print("=" * 65)
print("A16  â€”  4D TX+Antenna Refinement  (pc2, tr38901 + Nelder-Mead)")
print("=" * 65)
...
def main():
    ...
    ckpt_path = OUT / "pc2_a16_results.csv"
    if ckpt_path.exists():
    ...
    with open(OUT / "pc2_a16_summary.json", "w") as f:
        json.dump(summary, f, indent=2)
    print(f"Saved: out/pc2_a16_results.csv  out/pc2_a16_summary.json")
