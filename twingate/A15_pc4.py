...
def main():
    ...
    print(f"  pc4 train={len(train_all):,}  val={len(val_all):,}")
    ...
    # Load Sionna scene
    print("Loading Sionna scene (Op1)...")
    ...
    # Checkpoint
    ckpt_path = OUT / "pc4_refinement_results.csv"
    if ckpt_path.exists():
    ...
    with open(OUT / "pc4_refinement_summary.json", "w") as f:
