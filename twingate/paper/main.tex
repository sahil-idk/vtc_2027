...
\begin{enumerate}
  \item Development of a DT readiness framework: three quantitative
        metrics ($C$, M1, M2) that independently assess measurement
        quality, geometric fidelity, and functional coverage accuracy,
        each validated on a held-out temporal split.
...
whose session context is inconclusive.
